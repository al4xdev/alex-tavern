...
SOURCE = ROOT / "plans/artifacts/repetition-battery/base-P1-r2/sessions/bb72dc94/debug.jsonl"
HEADERS = (
...
def prepare() -> None:
    ...
    print("Prepared one real payload; B removes exactly two lines")

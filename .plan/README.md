...
|---|---|---|
| `tasks/` | **Active** tasks (open or delivered-with-reservations, banner at the top). Current retained tracks: 26 prose-quality evidence, 29.1-29.3 distribution monitor, 38 roteiro contracts, the final physical PID gate in 51, 53 narrator-hint materialization and 54 live-session narrative-kernel audit | When working |

...
|---|---|---|
| `tasks/` | **Active** tasks (open or delivered-with-reservations, banner at the top). Current retained tracks: 26 prose-quality evidence, 38 roteiro contracts, the final physical PID gate in 51 | When working |

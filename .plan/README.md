...
|---|---|---|
| `tasks/` | **Active** tasks (open or delivered-with-reservations, banner at the top). Current retained tracks: 26 prose-quality evidence, 29.1-29.3 distribution monitor, 38 roteiro contracts, and the final physical PID gate in 51 | When working |
